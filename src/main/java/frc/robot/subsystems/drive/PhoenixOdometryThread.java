...
// using
//  * a CANivore, the thread uses the "waitForAll" blocking method to enable more consistent
// sampling.
//  * This also allows Phoenix Pro users to benefit from lower latency between devices using
// CANivore
